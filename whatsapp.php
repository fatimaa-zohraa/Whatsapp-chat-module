...
class Whatsapp extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->version = '1.0.0';
        $this->author = 'Fatima Zohra Moumen';
        ...
        $this->description = $this->l('whatsapp chat');
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'desc' => $this->l('Entrer un numéro valide'),
    ...
    protected function getConfigFormValues()
    {
        return array(
            ...
            'WHATSAPP_ACCOUNT_EMAIL' => Configuration::get('WHATSAPP_ACCOUNT_EMAIL', ''),
